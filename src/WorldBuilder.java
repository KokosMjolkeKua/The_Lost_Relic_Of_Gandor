...
public class WorldBuilder {
    ...
    public static Room createWorld() {
        ...
        Room r14 = reg(14, new GenericRoom("You reached this ledge by climbing from room 10. A path west drops into room 11, and a path continues north."));
        Room r15 = reg(15, new GoblinRoom("A goblin rushes you. If you hesitate for too long, you die. Defeating it yields a needle and a red ruby. Only the path back remains.", new Enemy("Goblin", 16, 4)));
        Room r16 = reg(16, new GenericRoom("Dense forest under a light rain. Paths lead south, east, and north."));
        Room r17 = reg(17, new GenericRoom("A small clearing. A mural among the flowers gives you chills."));
        Room r18 = reg(18, new GenericRoom("A harmless slime crawls toward you. You may run; if you strike it, it flees."));
        ...
        Room r21 = reg(21, new GenericRoom("A goblin spots you and darts east. Paths continue east and north."));
        Room r22 = reg(22, new GenericRoom("A long path with murky waters on either side — swamp-like and dreary. The path continues north."));
        Room r23 = reg(23, new GoblinRoom("A stronger goblin stands his ground. You'll need the rusty dagger to best him. He drops arrows and a broken bow. A path leads east.", new Enemy("Hardened Goblin", 20, 5)));
